...
def add_to_books():
    ...
    #connection setup
        ...
        conn = sql.connect(host='localhost', user='root', passwd='2024', auth_plugin='mysql_native_password')
...
def dele_window():
    ...
    def _del_():
        ...
        c=conn.cursor()                                     
        c.execute('use library')
        c.execute('''delete from borrower_details where book_code = {} '''.format(int(code.get())))
...
#a=Toplevel()
#connection setup
    #mydb=sql.connect(host='localhost',user='root',passwd ='7617',auth_plugin='mysql_native_password',db='library')
    mydb = sql.connect(host='localhost', user='root', passwd='2024', auth_plugin='mysql_native_password', db='library')
    cursor = mydb.cursor()
...
def new_window():
    ...
    def update():
        #connection setup
        #conn=sql.connect(host='localhost',user='root',passwd ='7617',auth_plugin='mysql_native_password')
        conn = sql.connect(host='localhost', user='root', passwd='2024', auth_plugin='mysql_native_password')
        if conn.is_connected():
            print('Succesfully conected.')
        else:
